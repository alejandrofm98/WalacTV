...
private val SERIES_QUALITY_ORDER = mapOf(
        ...
        .map { episodes ->
            ...
            if (candidates.size == 1) {
                ...
                val qualityOptions = candidates.flatMap { variant ->
                    ...
                    .sortedWith(
                        compareByDescending<StreamOption> { SERIES_QUALITY_ORDER[it.quality ?: ""] ?: 0 }
                            .thenBy { it.language ?: "" },
                    )
                ...
                best.copy(
                    ...
                    badgeText = candidates.mapNotNull { extractQualityLabel(it.title) }
                        .distinct()
                        .sortedByDescending { SERIES_QUALITY_ORDER[it] ?: 0 }
                        .joinToString(" | "),
                )
            }
        }
